...
{
    public class BuscarTiposDocumentosCU<T> : AEjecutarCU<T>
    {
        private readonly IRepositorioTipoDocumento _fonosoftTipoDocumentoRepo;

        public BuscarTiposDocumentosCU(IResponse<T> response, IRepositorioTipoDocumento fonosoftTipoDocumentoRepo) : base(response)
        {
            this._fonosoftTipoDocumentoRepo = fonosoftTipoDocumentoRepo;
        }
