...
using WS_Fonosoft.Src.TipoContacto.Infraestructura;
...
builder.Services.AddScoped<IResponse<ITipoContacto>, Response<ITipoContacto>>();
...
builder.Services.AddScoped<IRepositorioTipoContacto>(_ => new FonosoftTipoContactoRepo(serverMySql, userMySql, databaseMysql, portMysql, passwordMysql));
#endregion
#region ENCRIPTACION
